...
Finally, here's how to do a permutation test. We'll just use the
"loco" method. To save time, we'll just do 100 permutations.
...
Here is how we would do a permutation test. To save time, we'll just
do 100 permutations.
...
`scan_func=scan1snps`. We'll just do 100 permutations, to save time.
