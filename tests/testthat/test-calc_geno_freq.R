...
test_that("calc_geno_freq works for an intercross", {
    ...
    # by individual
    expected <- list(A = structure(c(0.265431865621607, 0.179999497125949, 0.437768300719857,
                                     0.530653642640462, 0.296799833658536, 0.289346860233589),
                                   dim = 2:3, dimnames = list(c("88", "105"), c("SS", "SB", "BB"))),
                     X = structure(c(0, 0, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 0.5), dim = c(2L, 6L),
                                   dimnames = list(c("88", "105"), c("SS", "SB", "BS", "BB", "SY", "BY"))))
    ...
    # by marker
    expected <- list(A = structure(c(0.268363278479528, 0.278689258334566, 0.48461632550778,
                                     0.477608930381241, 0.247020396012691, 0.243701811284194),
                                   dim = 2:3, dimnames = list(c("D19Mit68", "D19Mit37"), c("SS", "SB", "BB"))),
                     X = structure(c(0.121465495590373, 0.117994689355019, 0.139097884691317,
                                     0.142568690926671, 0.112701216600633, 0.116172022835987,
                                     0.116172022835987, 0.112701216600633, 0.239547079613345,
                                     0.253430304554763, 0.271016300668345, 0.257133075726927),
    ...
    expected <- structure(c(0.510671441233419, 0.517493723525186, 0.486912125849693, 0.500795350791111,
                          ...
                          dim = c(4L, 2L), dimnames = list(c("D19Mit68", "D19Mit37", "DXMit16", "DXMit186"), c("S", "B")))
